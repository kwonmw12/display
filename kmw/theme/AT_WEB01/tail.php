...
<div id="ft">
    <div id="ft_wr">
       <div id="ft_sns">
        ...
        <div id="ft_company">
            <ul>
                <li class="ft_company1">상호 : (주)휴마트컴퍼니</li>
                <li class="ft_company2">대표 : 김동현</li>
                <li class="ft_company3">주소 : 서울특별시 서초구 강남대로 621 K-TOWER 9층</li>
                <li class="ft_company4">메일 : TROST@HU-MART.COM</li>
                <li class="ft_company5">고객 문의 : 카카오톡 플러스친구 '트로스트'</li>
                <li class="ft_company6">통신판매업 신고번호 : <a href="javascript:;">[사업자정보확인]</a></li>
            </ul>
        </div>
        
        <div id="ft_copy">
            Humart Company Co., &copy; <b>Ltd.</b> <span>All rights reserved.</span>
        </div>
    </div>
