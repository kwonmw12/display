...
<div class="bannerWrap">
    <img src="<?php echo G5_THEME_IMG_URL ?>/main/golbang2.jpg">
    <div>
        <img class="wow fadeInDown" data-wow-delay="0s" src="<?php echo G5_THEME_IMG_URL ?>/img/img_navi_logo.svg">
        <h2 class="wow fadeInDown" data-wow-delay="0.3s">골뱅이소면에 소주한잔 하고 싶다...</h2>
        <p class="wow fadeInDown" data-wow-delay="0.6s">고르뱅이 스토어에서 골뱅이 소면 파나?<span>획기적인 기획과 저가격으로 최고의 효과로 마케팅을 합니다.</span></p>
...
<div class="coreComWrap">
   <div class="box inner">
        <div class="main_title">
            <h2 class="wow fadeInDown" data-wow-delay="0.3s"><span>안녕?</span>나의 능력치</h2>
