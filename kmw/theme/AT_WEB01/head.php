    ...
    $(function() {
        ...
        setInterval(function() {
            if ($(window).scrollTop() >= 90) {
                ...
                $("#logo img.logo_pc").attr("src", "<?php echo G5_THEME_IMG_URL ?>/img/img_navi_logo.svg");
            } else {
        ...
        <div class="inner">
            ...
            <div id="logo">
                <a href="<?php echo G5_URL ?>">
                    <img class="logo_pc" src="<?php echo G5_THEME_IMG_URL ?>/img/img_navi_logo.svg" alt="<?php echo $config['cf_title']; ?>">
                    <img class="logo_mobile" src="<?php echo G5_THEME_IMG_URL ?>/img/img_navi_logo.svg" alt="<?php echo $config['cf_title']; ?>">
                </a>
            </div>
